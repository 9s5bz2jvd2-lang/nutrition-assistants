@echo off
REM Install script for Diabetes Food Guide Skill
REM Usage: install.bat

set SKILL_DIR=%USERPROFILE%\.workbuddy\skills\custom\diabetes-food-guide-skill
...
echo Diabetes Food Guide Skill installed to: %SKILL_DIR%
pause
